...
/// Unicode ranges for LETTER, generated from the Unicode Character
/// Database via `unicodedata` and embedded so this crate needs no
/// regex or unicode dependency. 660 ranges.
...
/// Unicode ranges for NUMBER, generated from the Unicode Character
/// Database via `unicodedata` and embedded so this crate needs no
/// regex or unicode dependency. 137 ranges.
pub static NUMBER: [(u32, u32); 137] = [
...
/// Unicode ranges for WHITESPACE, generated from the Unicode Character
/// Database via `unicodedata` and embedded so this crate needs no
/// regex or unicode dependency. 10 ranges.
pub static WHITESPACE: [(u32, u32); 10] = [
